...
.controller('MainCtrl', [
  ...
  function($scope,$http,$window){
    ...
    var bURL = 'http://localhost:3000' + '/sky/event/'+$scope.eci+'/eid/timing/started';
    ...
    var iURL = 'http://localhost:3000' + '/sky/event/'+$scope.eci+'/eid/timing/finished';
    ...
    var gURL = 'http://localhost:3000' + '/sky/cloud/'+$scope.eci+'/timing_tracker/entries';
