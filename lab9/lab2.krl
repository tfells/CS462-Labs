ruleset wovyn_base {
  meta {
    name "wovyn"
    provides getThreshold, getTo, getLocation, getName, getCurTemp
    shares getThreshold, getTo, getLocation, getName, getCurTemp
  }
  ...
  rule process_heartbeat {
    ...
    fired {
      ...
      ent:curTemp := gen{"data"}{"temperature"}[0]{"temperatureF"}
    }
  }
